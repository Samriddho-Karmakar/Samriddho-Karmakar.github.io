...
const projects = [
  {
    ...
    about: 'Mithu Web IDE is a browser-based coding environment designed for students, beginners, and developers who want a simple place to write and test code. It supports multiple web languages, provides file management, and includes a live preview so users can see their work instantly without constantly switching tools. It solves the problem of needing separate software for editing, organizing, and previewing web projects.',
  ...
  },
  {
    ...
    about: 'SK DrawTools is a creative drawing application that lets users create digital sketches, diagrams, and simple visual designs using an easy-to-use interface. It is aimed at students, hobbyists, and anyone who needs a lightweight tool for quickly turning ideas into drawings. The project focuses on making basic digital creation accessible without the complexity of professional design software.',
  ...
  },
  {
    ...
    about: "This project involved building a website for Samriddho Computer Education, a computer training institute that needed an online presence for showcasing courses, providing admission information, sharing contact details, and managing student-related information. I designed and developed the website, including features such as student details and QR-based certificates, to make the institute's services more accessible online. My role covered the overall web development, functionality, and user experience of the platform.",
